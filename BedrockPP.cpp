...
int injectMinecraft(HANDLE minecraft) {
	...
	unsigned char codeCavePatch[95] = { 0x48, 0x8B, 0x15, 0x5D, 0x7E, 0x14, 0x01, 0x48, 0x8B, 0x92, 0x98, 0x09, 0x00, 0x00, 0x48, 0x8B, 0x92, 0x88, 0x00, 0x00, 0x00, 0x48, 0x8B, 0x92, 0x7F, 0x01, 0x00, 0x00, 0x4C, 0x89, 0x15, 0x3D, 0x00, 0x00, 0x00, 0x49, 0xBA, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x4C, 0x39, 0xD2, 0x74, 0x0F, 0xF3, 0x0F, 0x10, 0x88, 0xF0, 0x00, 0x00, 0x00, 0x4C, 0x8B, 0x15, 0x1F, 0x00, 0x00, 0x00, 0xE9, 0xBA, 0x7E, 0xB7, 0xFE, 0xF3, 0x0F, 0x10, 0x0D, 0x16, 0x00, 0x00, 0x00, 0x4C, 0x8B, 0x15, 0x0B, 0x00, 0x00, 0x00, 0xE9, 0xA6, 0x7E, 0xB7, 0xFE, 0x90, 0x00, 0x00, 0x00, 0x00 };
	DWORD oldProt = 0;
	if (VirtualProtectEx(minecraft, (LPVOID)codeCaveAddr, 100, PAGE_EXECUTE_READWRITE, &oldProt) == 0) {
		std::cout << GetLastError();
	}
	if (WriteProcessMemory(minecraft, (LPVOID)codeCaveAddr, codeCavePatch, 95, NULL) == 0) {
		std::cout << GetLastError();
	}
